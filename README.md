...
| **apache-ua-keywords** | Combined User-Agent jail (empty UA, python, headless, …) — one jail instead of one per keyword. Darwin is not used: it matches every iOS/macOS browser. |
